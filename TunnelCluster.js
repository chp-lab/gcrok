    ...
    const connLocal = () => {
      ...
      local.once('connect', () => {
        ...
        const trackDataUsage = async (chunk) => {
          ...
          if (this.totalDataUsed >= this.ONE_GB) {
